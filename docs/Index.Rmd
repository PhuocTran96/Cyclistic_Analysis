...
1. I began importing the 12 data files into MySQL Workbench using the following [query]().
...
* d. Exported the resulting table, which contained `5,857,272` records (this process took a significant amount of time to complete).
  ...
  This is the query I used for these steps: [single query]().
...
Of course, you can view my script [here]().
...
# Visualization tool: Miscrosoft Power BI (PBI)
